<template>
    <div>
        <div
            ...
            <div class="md:hidden flex items-center space-x-[20px]">
                <div class="w-[38px] h-[38px] overflow-hidden rounded-[19px]">
                    <img src="/avi.svg" class="w-full h-full object-contain" />
                </div>
                <div
                    :class="isDark ? 'w-[40px] sdark h-[40px] cursor-pointer p-[11px] flex items-center border-[0.769px] border-[#dadddd] rounded-[27px]' : 'w-[40px] h-[40px] cursor-pointer p-[11px] flex items-center border-[0.769px] border-[#dadddd] rounded-[27px]'">
            ...
            <div class="space-x-[32px] hidden md:flex items-center">
                <div
                    :class="isDark ? 'w-fit md:hidden lg:hidden space-x-[8px] xl:flex items-center border border-[#dadddd] pl-[16px] rounded-[24px] sdark' : 'w-fit md:hidden lg:hidden space-x-[8px] xl:flex items-center border border-[#dadddd] pl-[16px] rounded-[24px] bg-[#fff]'">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                :fill="isDark ? '#fff' : '#78828A'" />
                        </svg>
                    </div>
                    <div class="l:w-[230px] xl:w-[270px]">
                        <input placeholder="Search..." type="text"
                            :class="isDark ? 'py-[12px] inter w-full bg-[transparent] pr-[16px] text-[#fff] text-[16px] font-[400] leading-[24px] focus:outline-none' : 'py-[12px] inter w-full bg-[transparent] pr-[16px] text-[#A3A3A3] text-[16px] font-[400] leading-[24px] focus:outline-none'" />
                    </div>
                </div>
                <div
        ...
        <div v-show="menu" class="w-full z-[30] hidden md:flex items-center justify-between top-[80px] fixed p-[20px]">
            ...
            <div
                ...
                <div class="flex items-center space-x-[10px] px-[11px]">
                    <div class="w-[38px] h-[38px] overflow-hidden rounded-[19px]">
                        <img @click="toggleMenu" src="/avi.svg" class="w-full h-full object-contain" />
                    </div>
                    <div
                        :class="isDark ? 'inter text-[#fff] cursor-pointer text-[12px] font-[800]' : 'inter cursor-pointer text-[12px] font-[700]'">
                        Justin Bergson</div>
                </div>
                <div
        ...
        <!--Notification Tab-->
        <div v-show="notify" class="w-full z-[30] hidden md:flex items-center justify-between top-[80px] fixed p-[20px]">
            <div></div>
            <div
                :class="isDark ? 'sdark pt-[20px] space-y-[15px] border border-[#fff] relative right-[190px] shadow-md w-[400px] rounded-[5px]' : 'bg-[#fff] right-[190px] pt-[20px] space-y-[15px] relative shadow-md w-[400px] rounded-[5px]'">
                <div class="flex px-[30px] mb-[60px] justify-between items-center w-full">
                    <div
                        :class="isDark ? 'plus font-[600] text-[19px] text-[#fff]' : 'plus font-[600] text-[19px] text-[#000]'">
                        Notification Tab
                    </div>
                    <div @click="NotifyToggle" class="plus cursor-pointer font-[400] text-[15px] text-red-600">
                        Close
                    </div>
                </div>
                <div
                    :class="isDark ? 'w-[60%] text-[18px] inter pb-[30px] text-slate-50 text-center mx-auto' : 'w-[60%] text-[18px] inter pb-[30px] text-slate-500 text-center mx-auto'">
        ...
        <div v-show="bigM" class="fixed w-full z-[2000] md:hidden bg-[transparent] h-full top-0 left-0">
            <div class="w-full h-full flex flex-row md:flex md:flex-row">
                <div
                    ...
                    <div class="pl-[28px] mb-[32px] flex items-center justify-between">
                    ...
                    <div class="w-full mb-[32px] px-[28px]">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none">
                            <path d="M2 12.98V15C2 20 4 22 9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9"
                                stroke="#B2ABAB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M11.17 12L10.7 11.3L7.5 14.5" stroke="#B2ABAB" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16.5 9.5L14.99 11.01L14 12" stroke="#B2ABAB" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M14.5 9.5H16.5V11.5" stroke="#B2ABAB" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </div>
                    <div class="w-full mb-[32px] px-[28px]">
                    ...
                    <div class="w-full mb-[32px] px-[28px]">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none">
                            <path d="M3.16992 7.44006L11.9999 12.55L20.7699 7.47003" stroke="#B7B0B0" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12 21.61V12.54" stroke="#B7B0B0" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                                ...
                                stroke="#B7B0B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16.9998 13.24V9.58002L10.9297 6.07001L9.87976 5.46997L7.50977 4.09998"
                                stroke="#B7B0B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                    <div class="w-full mb-[32px] px-[28px]">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <path
                                ...
                                stroke="#B2ABAB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M9 15L15 9" stroke="#B2ABAB" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M14.4945 14.5H14.5035" stroke="#B2ABAB" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M9.49451 9.5H9.50349" stroke="#B2ABAB" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </div>
                    <div class="w-full cursor-pointer mb-[24px] px-[28px]">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none">
                            <path d="M12 8V13" stroke="#B2ABAB" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                                d="M4 6C2.75 7.67 2 9.75 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2C10.57 2 9.2 2.3 7.97 2.85"
                                stroke="#B2ABAB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M11.9946 16H12.0036" stroke="#B2ABAB" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </div>
                    ...
                    <div class="w-full mb-[32px] px-[28px]">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <path
                                ...
                                stroke="#B2ABAB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                    ...
                    <div class="w-full px-[28px]">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none">
                            <path d="M6.56 14.5599L4 11.9999L6.56 9.43994" stroke="#B2ABAB" stroke-width="1.5"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M9.23982 12H4.06982" stroke="#B2ABAB" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M14.2398 12H12.2798" stroke="#B2ABAB" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M18.01 6.47998C19.25 7.83998 20 9.70998 20 12C20 17 16.42 20 12 20" stroke="#B2ABAB"
...
const toggleMenu = () => {
    ...
    notify.value = false;
    gsap.fromTo('.menu', { height: 0 }, { height: 'auto', duration: 0.6, })
}
