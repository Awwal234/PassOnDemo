            ...
            <div
                ...
                <div class="flex w-full mb-[21.5px] justify-between items-center">
                    ...
                    <div class="flex space-x-[10px] items-center">
                        ...
                        <div
                            class="w-fit cursor-pointer flex items-center border-[#e1dfdf] border-[1px] rounded-[20px] py-[6px] px-[12px]">
                            <div class="text-[#3a3f51] plus text-[12px] leading-[16px] font-[400]">Weekly</div>
                            <div>
                ...
                <div class="md:flex block mb-[16px] md:space-x-[8px] w-full">
                    <div
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="106" height="33" viewBox="0 0 106 33"
                                    ...
                                    <path
                                        ...
                                        stroke="#66C87B" stroke-linecap="round" />
                                    <defs>
                                        <linearGradient id="paint0_linear_2132_4599" x1="53" y1="33" x2="53" y2="1"
                        ...
                        <div class="flex w-full items-center justify-between">
                            <div class="w-[35%]">
                                <div class="flex green w-fit space-x-[4px] items-center">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6"
                                            fill="none">
                                            <path d="M0.5 5.5L3.5 2.5L5.5 4.5L9.5 0.5" stroke="#34CAA5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6 0.5H9.5V4" stroke="#34CAA5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    </div>
                                    <div class="text-[#34caa5] leading-[16px] font-[500] text-[12px] plus">
                                        23, 5%
                                    </div>
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex mb-[10px] justify-between items-center">
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="106" height="33" viewBox="0 0 106 33"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_2133_4687" x1="53" y1="33" x2="53" y2="1"
                                            gradientUnits="userSpaceOnUse">
                        ...
                        <div class="flex w-full items-center justify-between">
                            <div class="w-[35%]">
                                <div class="flex red w-fit space-x-[4px] items-center">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6"
                                            fill="none">
                                            <path d="M0.5 0.5L3.5 3.5L5.5 1.5L9.5 5.5" stroke="#ED544E"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6 5.5H9.5V2" stroke="#ED544E" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    </div>
                                    <div class="text-[#ed544e] leading-[16px] font-[500] text-[12px] plus">
                                        23, 5%
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="106" height="33" viewBox="0 0 106 33"
                                    ...
                                    <path
                                        ...
                                        stroke="#ED544E" stroke-linecap="round" />
                                    <defs>
                                        <linearGradient id="paint0_linear_2133_4778" x1="53" y1="33" x2="53" y2="1"
                                            gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#ED544E" stop-opacity="0" />
                                            <stop offset="0.809892" stop-color="#ED544E" />
                                        </linearGradient>
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="106" height="33" viewBox="0 0 106 33"
                                    ...
                                    <path
                                        ...
                                        stroke="#66C87B" stroke-linecap="round" />
                                    <defs>
                                        <linearGradient id="paint0_linear_2133_4739" x1="53" y1="33" x2="53" y2="1"
                                            gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#77B900" stop-opacity="0" />
                                            <stop offset="0.809892" stop-color="#77B900" />
                                        </linearGradient>
